...
{
$a=$_GET['did'];
$sqi=mysqli_query($con,"DELETE FROM career WHERE id='$a'");
header("Location:viewc.php");
}
else
{
	$sql=mysqli_query($con,"SELECT * FROM career");
...
<td width="100px" height="50px" >contact</td>
<td width="100px" height="50px" >skills</td>
<td width="100px" height="50px" >message</td>
<td width="100px" height="50px" >myFile</td>
</tr>
<?php
if($count>0) {
$i=1;
...
<td width="100px" height="50px" ><?php echo $row["contact"];?></td>
<td width="100px" height="50px" ><?php echo $row["skills"];?></td>
<td width="100px" height="50px" ><?php echo $row["message"];?></td>
<td width="100px" height="50px" ><?php echo $row["myFile"];?></td>
<td width="100px" height="100px" >
<a href="viewc.php?did=<?php echo$row['id'];?>">delete</a>
